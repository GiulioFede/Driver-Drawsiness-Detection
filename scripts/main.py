...
class DrawsinessEvaluator(object):
    ...
    def PERCLOS_f(self):
        ...
        if self.isEARFineTuned == False:
            ...
            cv2.putText(self.last_frame, "EAR fine tuning... EAR= {:.2f}".format(0.7*self.EAR_THREASHOLD), (60, 260), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
            ...
            if self.total_number_of_frames > 30*5: #ho supposto di calcolare EAR in 20 secondi
                ...
                self.EAR_THREASHOLD = self.EAR_THREASHOLD*0.7
            else:
                return
        ...
        if self.number_of_closed_frames+self.number_of_opened_frames < 30*40: #current_fps*60=numero di frame collezionabili in 60 secondi
            ...
            if(first_frame_in_time_window == 1):
                self.number_of_opened_frames = self.number_of_opened_frames - 1
            else: #if is closed
                 self.number_of_closed_frames = self.number_of_closed_frames - 1
        ...
        cv2.putText(self.last_frame, "Numero frame occhi aperti= {:.2f}".format(self.number_of_opened_frames), (10, 280), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 1)
        cv2.putText(self.last_frame, "Numero frame occhi chiusi= {:.2f}".format(self.number_of_closed_frames), (10, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 1)
